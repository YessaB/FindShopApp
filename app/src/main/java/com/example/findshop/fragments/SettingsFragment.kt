...
import com.example.findshop.SignInActivity
...
class SettingsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val userIdTextView = view?.findViewById<TextView>(R.id.user_id_textview)
        val userID = activity?.intent?.getIntExtra("puserID", -1)
        val userNAME = activity?.intent?.getStringExtra("pusername")
        val userEMAIL= activity?.intent?.getStringExtra("puseremail")


        // Set the text of the TextViews to the user details
